        ...
        <div class="col-md-5">
            <div class="card">
                <div class="card-header text-center" style="background-color: orange">
                    ...
                    <a href="/" class="logo">
                        <img src="images/jeep.png" alt="Changa-K"  style="width:30px "/>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="phone" class="col-md-12 col-form-label text-md-end">{{ __('Phone No') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-12 col-form-label text-md-end">{{ __('Confirm ') }}</label>
